...
-sop | --bkmk-save-psg | `$ EsvApiInterface -sop 1` | Saves Ephesians 5</br>as eph5.html in your</br>current directory<sup><div title="text">1</div></sup>


<!--  <sup>[\[1\]](#1-this-is-the-most-squared-away-method)</sup>-->
