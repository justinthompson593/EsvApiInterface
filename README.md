...
---- | ----------- | ------
-op | `$ EsvApiInterface 1John1 -op` | Opens first John chapter 1 as an html file in your default web browser
-sp | `$ EsvApiInterface 1John1 -sp` | Saves first John chapter 1 as 1John.html in your current directory
-ot | `$ EsvApiInterface Gen3 -ot` | Opens Genesis chapter 3 as a text file in your default text editor
-st | `$ EsvApiInterface 1John1 -sp` | Saves first John chapter 1 as 1John.html in your current directory
-o3 | `$ EsvApiInterface Mat5:3-11 -o3` | Opens the link to Matthew chapter 5 verses 3 through 11 audio (as an mp3) in your default web browser 
