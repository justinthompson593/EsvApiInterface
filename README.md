...
**Important** if you use the flag `-B`, or one with the type `-bxx` below (_any flag except_ `-bm`) it **must** be followed by either a passage query, or a bookmark name, respectively.
