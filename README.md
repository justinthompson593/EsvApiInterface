...
**Important** if you use any of the bookmark flags below (_except -bc and -bm_) they **must** be followed by eithar a passage query, or a bookmark name depending on if the flag is -B, or -b\*\*, respectively.
